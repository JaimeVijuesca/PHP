...
-- Tiempo de generación: 06-02-2024 a las 17:13:31
...
--
INSERT INTO
  `permisos` (`id_permiso`, `id_menu`, `codigos`, `permiso`)
VALUES
  (1, 1, 'ver', 'S'),
  (2, 2, 'editar', 'S');
...
--
INSERT INTO
  `permisosroles` (`id_rol`, `id_permiso`)
VALUES
  (1, 1),
  (1, 2);
...
--
INSERT INTO
  `permisosusuario` (`id_usuario`, `id_permiso`)
VALUES
  (1, 1),
  (1, 2);
...
--
INSERT INTO
  `rolesusuarios` (`id_rol`, `id_usuario`)
VALUES
  (1, 1),
  (1, 2),
  (2, 3),
...
ALTER TABLE
  `permisos`
ADD
  CONSTRAINT `fk_permisos_menu` FOREIGN KEY (`id_menu`) REFERENCES `menu` (`id_menu`);
...
ALTER TABLE
  `permisosroles`
ADD
  CONSTRAINT `fk_permisosRoles_permiso` FOREIGN KEY (`id_permiso`) REFERENCES `permisos` (`id_permiso`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD
  CONSTRAINT `fk_permisosRoles_rol` FOREIGN KEY (`id_rol`) REFERENCES `roles` (`id_rol`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE
  `permisosusuario`
ADD
  CONSTRAINT `fk_permisosUsuario_permiso` FOREIGN KEY (`id_permiso`) REFERENCES `permisos` (`id_permiso`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD
  CONSTRAINT `fk_permisosUsuario_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_Usuario`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE
  `rolesusuarios`
ADD
  CONSTRAINT `rolesusuarios_ibfk_1` FOREIGN KEY (`id_rol`) REFERENCES `roles` (`id_rol`);
